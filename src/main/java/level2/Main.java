...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("List ordered by words containing 'e' first: " + LambdasStreamsUtils.getCharacterFirstSortedList(myList, 'e'));
        System.out.println("List changing 'a' by '4': " + LambdasStreamsUtils.getCharacterReplaceList(myList, 'a', '4'));
        System.out.println("List numeric elements: " + LambdasStreamsUtils.getNumericElementsList(myList));
    }
}
